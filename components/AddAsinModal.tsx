    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-sm max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <h2 className="font-semibold text-gray-900">إضافة ASIN</h2>
        ...
        <form onSubmit={handleSubmit} autoComplete="off" className="px-6 py-4 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              autoComplete="off"
              className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400"
              placeholder="عنوان الـ listing (اختياري)"
            />
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-3 space-y-3">
            ...
            <p className="text-xs text-gray-400">التكلفة تتضاف من "تكاليف الموردين" على المنتج</p>
          </div>
